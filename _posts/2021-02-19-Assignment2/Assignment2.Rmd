...
[Final Dashboard](https://public.tableau.com/profile/jihun.nam#!/vizhome/Covid_vaccine_dashboard_age_edit/DashboardFinal?publish=yes "click to link")
...
- If we see below dashboard we made earlier, average scores of the survey answer to "Q1. if a Covid-19 vaccine were made available to me this week, I would definitely get it" are varied by country. If you see the charts closely, people in EU countries are more likely to get vaccine, almost above average socre value of 3.39
- Especially, the average scores of answer in United Kingdom is higher than that in Japan by 0.9.
- Also, UK and Denmark people are more likely think that they strongly want to get vaccine if they are available. 
...
- As seen below, seniors (age group of 60-69) are more likely to get vaccine than relatively young group (age group of 30-39).
- Also, this result can be seen if we see the chart of "Answers by Employ status". The retired are likely to get vaccine than other groups.
...
- As seen below, worries about potential side effects of vaccine are getting smaller. 
- Also, people believe their government health authorities more than before.
...
![](/Users/1109103/Google Drive/SMU_2021_1st/Visual/blog/_posts/2021-02-19-Assignment2/capture/ob.8q4.png){width=100%}
